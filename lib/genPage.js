  ...
  for (var i = 0; i < engineerInput.length; i++) {
    ...
    <div class="bg-indigo-50 rounded-lg shadow-2xl m-8">
          ...
          <p class="py-1"><span class="font-medium">Name:</span> ${engineerInput[i].name}</p>
              ...
              <p class="py-1"><span class="font-medium">ID#:</span> <a href="mailto:${engineerInput[i].email}" class="hover:text-indigo-900 hover:bg-indigo-100 hover:rounded">${engineerInput[i].email}</a></p>
              <p class="py-1"><span class="font-medium">Github Page:</span> <a href="${engineerInput[i].githubPage}" class="hover:text-indigo-900 hover:bg-indigo-100 hover:rounded">${engineerInput[i].githubName}</a></p>
          </div>
        </div>
    `
  }
  ...
  for (var i = 0; i < internInput.length; i++) {
    ...
    <div class="bg-indigo-50 rounded-lg shadow-2xl m-8">
          ...
          <div class="p-8">
              ...
              <p class="py-1"><span class="font-medium">Email:</span> <a href="mailto:${internInput[i].email}" class="hover:text-indigo-900 hover:bg-indigo-100 hover:rounded">${internInput[i].email}</a></p>
