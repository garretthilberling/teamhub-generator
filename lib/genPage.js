  ...
  for (var i = 0; i < engineerInput.length; i++) {
    ...
    <div class="bg-indigo-50 rounded-lg shadow-2xl m-8">
          ...
          <p class="py-1"><span class="font-medium">Name:</span> ${engineerInput[i].name}</p>
              ...
              <p class="py-1"><span class="font-medium">ID#:</span> <a href="${engineerInput[i].email}">${engineerInput[i].email}</a></p>
              <p class="py-1"><span class="font-medium">Github Page:</span> <a href="${engineerInput[i].githubPage}">${engineerInput[i].githubName}</a></p>
          </div>
        </div>
    `
  }
  ...
  for (var i = 0; i < internInput.length; i++) {
    ...
    <div class="bg-indigo-50 rounded-lg shadow-2xl m-8">
          ...
          <div class="p-8">
              ...
              <p class="py-1"><span class="font-medium">Email:</span> <a href="${internInput[i].email}">${internInput[i].email}</a></p>
  ...
  <main>
    ...
    <section class="mt-8 flex center-items justify-center">
      <div class="bg-indigo-50 rounded-lg shadow-2xl m-8">
        ...
        <div class="p-8">
            <p class="py-1"><span class="font-medium">Name:</span> ${input.manager.name}</p>
            <p class="py-1"><span class="font-medium">ID#:</span> ${input.manager.id}</p>
            <p class="py-1"><span class="font-medium">Email:</span> <a href="${input.manager.email}">${input.manager.email}</a></p>
